...
■ ${target_company_name}过去5年总资产的规模一直处于增长之中，并且最近4年的增长率大于10%，说明${target_company_name}一直处于快速成长之中，成长性较强。

■ ${target_company_name}最近三年总资产的规模大于200亿，资产规模比较大，说明${target_company_name}的实力比较强。
...
■${target2_company_name}${target2_y1}年的总资产为${target2_y1_total_assets}，规模不到${target_company_name}的四分之一，实力远不及${target_company_name}。

■ ${target3_company_name}${target3_y1}年的总资产为${target3_y1_total_assets}，规模不到${target_company_name}的十分之一，实力与${target_company_name}差距巨大。
...
■ ${target_company_name}从${y5}-${y1}连续5年的资产负债率整体在稳步上升，但负债率都小于40%，无偿债风险。

■ 过去5年${target_company_name}的资产负债率稳步上升，给人一种偿债风险在变大的感觉。其实${target_company_name}的偿债风险一点也没有变大，反而是核心竞争力在变强。
...
准货币资金-有息负债的差额越大越好，差额越大，说明企业的偿债能力好，没有偿债风险

对比一下同行

| ${target2_company_name} | ${targer2_y1}                                               | ${targer2_y2}                                               | ${targer2_y3}                                               | ${targer2_y4}                                               | ${targer2_y5}                                               |
| ----------------------- | ----------------------------------------------------------- | ----------------------------------------------------------- | ----------------------------------------------------------- | ----------------------------------------------------------- | ----------------------------------------------------------- |
| 短期借款                | ${targer2_y1_st_loan}                                       | ${targer2_y2_st_loan}                                       | ${targer2_y3_st_loan}                                       | ${targer2_y4_st_loan}                                       | ${targer2_y5_st_loan}                                       |
| 一年内到期的非流动负债  | ${targer2_y1_noncurrent_liab_due_in1y}                      | ${targer2_y2_noncurrent_liab_due_in1y}                      | ${targer2_y3_noncurrent_liab_due_in1y}                      | ${targer2_y4_noncurrent_liab_due_in1y}                      | ${targer2_y5_noncurrent_liab_due_in1y}                      |
| 长期借款                | ${targer2_y1_lt_loan}                                       | ${targer2_y2_lt_loan}                                       | ${targer2_y3_lt_loan}                                       | ${targer2_y4_lt_loan}                                       | ${targer2_y5_lt_loan}                                       |
| 应付债券                | ${targer2_y1_bond_payable}                                  | ${targer2_y2_bond_payable}                                  | ${targer2_y3_bond_payable}                                  | ${targer2_y4_bond_payable}                                  | ${targer2_y5_bond_payable}                                  |
| 长期应付款              | ${targer2_y1_lt_payable}                                    | ${targer2_y2_lt_payable}                                    | ${targer2_y3_lt_payable}                                    | ${targer2_y4_lt_payable}                                    | ${targer2_y5_lt_loan}                                       |
| 有息负债合计            | ${targer2_y1_total_interest_bearing_liabilities}            | ${targer2_y2_total_interest_bearing_liabilities}            | ${targer2_y3_total_interest_bearing_liabilities}            | ${targer2_y4_total_interest_bearing_liabilities}            | ${targer2_y5_total_interest_bearing_liabilities}            |
| 准货币资金-有息负债差额 | ${targer2_y1_currency_funds_interest_bearing_liabilities_c} | ${targer2_y2_currency_funds_interest_bearing_liabilities_c} | ${targer2_y3_currency_funds_interest_bearing_liabilities_c} | ${targer2_y4_currency_funds_interest_bearing_liabilities_c} | ${targer2_y5_currency_funds_interest_bearing_liabilities_c} |



| ${target3_company_name} | ${targer3_y1}                                               | ${targer3_y2}                                               | ${targer3_y3}                                               | ${targer3_y4}                                               | ${targer3_y5}                                               |
| ----------------------- | ----------------------------------------------------------- | ----------------------------------------------------------- | ----------------------------------------------------------- | ----------------------------------------------------------- | ----------------------------------------------------------- |
| 短期借款                | ${targer3_y1_st_loan}                                       | ${targer3_y2_st_loan}                                       | ${targer3_y3_st_loan}                                       | ${targer3_y4_st_loan}                                       | ${targer3_y5_st_loan}                                       |
| 一年内到期的非流动负债  | ${targer3_y1_noncurrent_liab_due_in1y}                      | ${targer3_y2_noncurrent_liab_due_in1y}                      | ${targer3_y3_noncurrent_liab_due_in1y}                      | ${targer3_y4_noncurrent_liab_due_in1y}                      | ${targer3_y5_noncurrent_liab_due_in1y}                      |
| 长期借款                | ${targer3_y1_lt_loan}                                       | ${targer3_y2_lt_loan}                                       | ${targer3_y3_lt_loan}                                       | ${targer3_y4_lt_loan}                                       | ${targer3_y5_lt_loan}                                       |
| 应付债券                | ${targer3_y1_bond_payable}                                  | ${targer3_y2_bond_payable}                                  | ${targer3_y3_bond_payable}                                  | ${targer3_y4_bond_payable}                                  | ${targer3_y5_bond_payable}                                  |
| 长期应付款              | ${targer3_y1_lt_payable}                                    | ${targer3_y2_lt_payable}                                    | ${targer3_y3_lt_payable}                                    | ${targer3_y4_lt_payable}                                    | ${targer3_y5_lt_loan}                                       |
| 有息负债合计            | ${targer3_y1_total_interest_bearing_liabilities}            | ${targer3_y2_total_interest_bearing_liabilities}            | ${targer3_y3_total_interest_bearing_liabilities}            | ${targer3_y4_total_interest_bearing_liabilities}            | ${targer3_y5_total_interest_bearing_liabilities}            |
| 准货币资金-有息负债差额 | ${targer3_y1_currency_funds_interest_bearing_liabilities_c} | ${targer3_y2_currency_funds_interest_bearing_liabilities_c} | ${targer3_y3_currency_funds_interest_bearing_liabilities_c} | ${targer3_y4_currency_funds_interest_bearing_liabilities_c} | ${targer3_y5_currency_funds_interest_bearing_liabilities_c} |
...
■ ${target_company_name}过去5年商誉占总资产的比率一直低于1%，2020年的比率仅为0.10%，${target_company_name}的商誉没有爆雷的风险。
...
■ 如果过去5年期间费用率与毛利率的比率在持续下降，成本管控能力在增强。如果期间费用率与毛利率的比率大于40%，小于60%，则成本管控能力谈不上优秀也不算太差。
...
■ 如果过去5年的销售费用率整体在10%左右，这说明公司的产品比较容易销售，销售风险较小。

■ 如果过去5年的销售费用率一直高于15%，这说明公司产品不太容易销售，需要大量的销售费用来推动销售，销售风险较大。
