...
| 有息负债/总资产               | ${y1_total_interest_bearing_liabilities_div_total_assets} | ${y2_total_interest_bearing_liabilities_div_total_assets}            | ${y3_total_interest_bearing_liabilities_div_total_assets}            | ${y4_total_interest_bearing_liabilities_div_total_assets}            | ${y5_total_interest_bearing_liabilities_div_total_assets}            |
...
| 其他非流动资产                    | ${target3_y1_othr_noncurrent_assets}            | ${target3_y2_othr_noncurrent_assets}            | ${target3_y3_othr_noncurrent_assets}            | ${target3_y4_othr_noncurrent_assets}            | ${target3_y5_othr_noncurrent_assets}            |
...
| 财务费用               | ${y1_financing_expenses}           | ${y2_financing_expenses}           | ${y3_financing_expenses}           | ${y4_financing_expenses}           | ${y5_financing_expenses}           |
| 四费合计               | ${y1_total_four_free}              | ${y2_total_four_free}              | ${y3_total_four_free}              | ${y4_total_four_free}              | ${y5_total_four_free}              |
| 营业收入               | ${y1_revenue}                | ${y2_revenue}                | ${y3_revenue}                | ${y4_revenue}                | ${y5_revenue}                |
| 营业成本               | ${y1_operating_cost}               | ${y2_operating_cost}               | ${y3_operating_cost}               | ${y4_operating_cost}               | ${y5_operating_cost}               |
...
| 财务费用                | ${target2_y1_financing_expenses}            | ${target2_y2_financing_expenses}            | ${target2_y3_financing_expenses}            | ${target2_y4_financing_expenses}            | ${target2_y5_financing_expenses}            |
| 四费合计                | ${target2_y1_total_four_free}               | ${target2_y2_total_four_free}               | ${target2_y3_total_four_free}               | ${target2_y4_total_four_free}               | ${target2_y5_total_four_free}               |
| 营业收入                | ${target2_y1_revenue}                 | ${target2_y2_revenue}                 | ${target2_y3_revenue}                 | ${target2_y4_revenue}                 | ${target2_y5_revenue}                 |
| 营业成本                | ${target2_y1_operating_cost}               | ${target2_y2_operating_cost}               | ${target2_y3_operating_cost}               | ${target2_y4_operating_cost}               | ${target2_y5_operating_cost}               |
...
| 财务费用                | ${target3_y1_financing_expenses}            | ${target3_y2_financing_expenses}            | ${target3_y3_financing_expenses}            | ${target3_y4_financing_expenses}            | ${target3_y5_financing_expenses}            |
| 四费合计                | ${target3_y1_total_four_free}               | ${target3_y2_total_four_free}               | ${target3_y3_total_four_free}               | ${target3_y4_total_four_free}               | ${target3_y5_total_four_free}               |
| 营业收入                | ${target3_y1_revenue}                 | ${target3_y2_revenue}                 | ${target3_y3_revenue}                 | ${target3_y4_revenue}                 | ${target3_y5_revenue}                 |
| 营业成本                | ${target3_y1_operating_cost}               | ${target3_y2_operating_cost}               | ${target3_y3_operating_cost}               | ${target3_y4_operating_cost}               | ${target3_y5_operating_cost}               |
...
■ 利润表中的利润总额和净利润并不太重要，虽然它们被经常使用。

■ 从投资的角度来看，主营利润的重要性大于营业利润，营业利润的重要性大于利润总额和净利润。

■ 虽然净利润相对不那么重要，但是它毕竟是企业的最终经营成果，很多关键的财务指标也和净利润相关，
我们还是要重点看一下净利润。

■ 净利润主要看规模和含钱量，规模越大越好，含钱量越高越好。

■ 最优秀的公司净利润现金含量会持续大于 120%，优秀的公司净利润现金含量会持续大于 100%。

■ 在投资实践中，一般把过去 5 年净利润现金含量小于 100%的公司淘汰掉。

■ 净利润现金含量的计算公式为：净利润现金含量=经营活动产生的现金流量净额/净利润*100%，经营
活动产生的现金流量净额需要在现金流量表中查看。
...
# 识别通过虚增货币资金来虚增收入的财务造假风险

虚增货币资金指账面上增加了货币资金，但实际上银行账户里并没有这笔现金。

■ 采用这种方式造假的公司也是和关联公司签署购销合同，然后虚增货币资金科目里的金额而不是应收账款科目里的金额，这样通过财务报表就相对不容易被发现，但是这很容易被审计发现。

■ 因为银行里明明没有那么多钱，你财报上却显示有那么多钱。

■ 那么怎么办呢？方法还是有的，造假公司可以通过私刻印章、虚假回函、伪造存单、伪造流水等手段来骗过审计。

■ 总之该提供给审计的存款单，银行流水啥的都和真的一样，但都是假的。

■ 由于审计公司都是收上市公司服务费的，所以审计也经常能被骗到。

■ 在目前这种审计机制下，即使是福尔摩斯来做审计，也会成功被骗的。

■ 不过骗过审计容易，想骗过微淼同学难。这种造假水平虽然高明了一些，但是依然有识破的办法。

■ 货币资金造假依然是有迹可寻的，我们可以通过利息收入、利息支出及有息负债金额是否有异常来判断货币资金造假的可能性。

■ 如果货币资金是真的，每年的利息收入应该大于货币资金金额的2.5%，如果每年的利息收入小于货币资金金额的2%，则货币资金金额的真实性很可能有问题。

■ 另外还可以结合有息负债的金额和利息支出来进一步验证，如果一家公司账上有很多钱，但同时又有很多有息负债，每年需要支付高额利息，那么这家公司的货币资金很可能有问题。

■ 当利息收入小于货币资金金额的2%，并且利息支出占净利润的比例在10%以上时，说明货币资金有造假的嫌疑，需要高度重视。

 这就像是一个人告诉你他银行卡里有100万现金可以用，但是他却有90万的银行贷款，每年需要支付9万元的利息。你觉得他银行卡里真的有100万现金吗？

| ${target_company_name} | ${y1}                                                   | ${y2}                              | ${y3}                              | ${y4}                              | ${y5}                              |
|------------------------|---------------------------------------------------------|------------------------------------|------------------------------------|------------------------------------|------------------------------------|
| 货币资金                   | ${y1_currency_funds}                                    | ${y2_currency_funds}               | ${y3_currency_funds}               | ${y4_currency_funds}               | ${y5_currency_funds}               |
| 利息收入                   | ${y1_finance_cost_interest_income}                      | ${y2_finance_cost_interest_income} | ${y3_finance_cost_interest_income} | ${y4_finance_cost_interest_income} | ${y5_finance_cost_interest_income} |
| 利息收入占比货币资金             | ${y1_fcii_div_currency_funds}                           | ${y2_fcii_div_currency_funds}      | ${y3_fcii_div_currency_funds}      | ${y4_fcii_div_currency_funds}      | ${y5_fcii_div_currency_funds}      |
| 利息支出                   | ${y1_finance_cost_interest_fee}                         | ${y2_finance_cost_interest_fee}    | ${y3_finance_cost_interest_fee}    | ${y4_finance_cost_interest_fee}    | ${y5_finance_cost_interest_fee}    |
| 利息收入-利息支出              | ${y1_fcii_m_fcif}                                       | ${y2_fcii_m_fcif}           | ${y3_fcii_m_fcif}           | ${y4_fcii_m_fcif}           | ${y5_fcii_m_fcif}           |
| 净利润                    | ${y1_net_profit}                                        | ${y2_net_profit}                   | ${y3_net_profit}                   | ${y4_net_profit}                   | ${y5_net_profit}                   |
| 利息支出占比净利润              | ${y1_fcif_div_net_profit}                               | ${y2_fcif_div_net_profit}                   | ${y3_fcif_div_net_profit}                   | ${y4_fcif_div_net_profit}                   | ${y5_fcif_div_net_profit}                   |
| 预付款项                   | ${y1_pre_payment}                                       | ${y2_pre_payment}                             | ${y3_pre_payment}                             | ${y4_pre_payment}                             | ${y5_pre_payment}                             |
| 其他应收款                  | ${y1_othr_receivables}                                  | ${y2_othr_receivables}                             | ${y3_othr_receivables}                             | ${y4_othr_receivables}                             | ${y5_othr_receivables}                             |
| 总资产                    | ${y1_total_assets}                                      | ${y2_total_assets}                      | ${y3_total_assets}                      | ${y4_total_assets}                      | ${y5_total_assets}                      |
| (预付款项+其他应收款)占比总资产      | ${y1_pre_payment_add_othr_receivables_div_total_assets} | ${y2_pre_payment_add_othr_receivables_div_total_assets}                      | ${y3_pre_payment_add_othr_receivables_div_total_assets}                      | ${y4_pre_payment_add_othr_receivables_div_total_assets}                      | ${y5_pre_payment_add_othr_receivables_div_total_assets}                      |

通过虚增流动资产来虚增收入的财务造假

■ 这种财务造假通过虚增预付款项、其他应收款科目的金额把钱转到关联方公司，然后通过和关联公司签订购销合同形成“真实”的现金收入，从而虚增收入。

■ 举例：小黑公司想要虚增100万的现金收入，于是找到小黑公司的关联公司小白公司，小黑公司先私下转钱100万给小白公司，小黑对外会说这100万是预付给了原材料供应商或者说是把钱借给了别人，这样就会形成预付款项或者其他应收款而记录进小黑公司的报表，然后小黑公司和关联公司小白公司签订购销合同，小白公司再把这100万转账给小黑公司，造成小黑公司有现金收入100万的迹象。
...
■ 所以当同学们遇到预付款项或其他应收款或（预付款项+其他应收款）占总资产的**比率大于10%的公司，还是要小心的，异常往往意味着风险，高度异常往往意味着高度风险**。
...
| ----------------------- |--------------------------------------------|--------------------------------------------|--------------------------------------------|--------------------------------------------|--------------------------------------------|
| 货币资金                | ${target2_y1_currency_funds}               | ${target2_y2_currency_funds}               | ${target2_y3_currency_funds}               | ${target2_y4_currency_funds}               | ${target2_y5_currency_funds}               |
| 利息收入                | ${target2_y1_finance_cost_interest_income} | ${target2_y2_finance_cost_interest_income} | ${target2_y3_finance_cost_interest_income} | ${target2_y4_finance_cost_interest_income} | ${target2_y5_finance_cost_interest_income} |
| 利息收入占比货币资金    | ${target2_y1_fcii_div_currency_funds}      | ${target2_y2_fcii_div_currency_funds}      | ${target2_y3_fcii_div_currency_funds}      | ${target2_y4_fcii_div_currency_funds}      | ${target2_y5_fcii_div_currency_funds}      |
| 利息支出                | ${target2_y1_finance_cost_interest_fee}    | ${target2_y2_finance_cost_interest_fee}    | ${target2_y3_finance_cost_interest_fee}    | ${target2_y4_finance_cost_interest_fee}    | ${target2_y5_finance_cost_interest_fee}    |
| 利息收入-利息支出              | ${target2_y1_fcii_m_fcif}                  | ${target2_y2_fcii_m_fcif}                  | ${target2_y3_fcii_m_fcif}                  | ${target2_y4_fcii_m_fcif}                  | ${target2_y5_fcii_m_fcif}                  |
| 净利润                     | ${target2_y1_net_profit}                   | ${target2_y2_net_profit}                   | ${target2_y3_net_profit}                   | ${target2_y4_net_profit}                   | ${target2_y5_net_profit}                   |
| 利息支出占比净利润              | ${target2_y1_fcif_div_net_profit}          | ${target2_y2_fcif_div_net_profit}                   | ${target2_y3_fcif_div_net_profit}                   | ${target2_y4_fcif_div_net_profit}                   | ${target2_y5_fcif_div_net_profit}                   |
| 预付款项                   | ${target2_y1_pre_payment}                                       | ${target2_y2_pre_payment}                             | ${target2_y3_pre_payment}                             | ${target2_y4_pre_payment}                             | ${target2_y5_pre_payment}                             |
| 其他应收款                  | ${target2_y1_othr_receivables}                                  | ${target2_y2_othr_receivables}                             | ${target2_y3_othr_receivables}                             | ${target2_y4_othr_receivables}                             | ${target2_y5_othr_receivables}                             |
| 总资产                    | ${target2_y1_total_assets}                                      | ${target2_y2_total_assets}                      | ${target2_y3_total_assets}                      | ${target2_y4_total_assets}                      | ${target2_y5_total_assets}                      |
| (预付款项+其他应收款)占比总资产             | ${target2_y1_pre_payment_add_othr_receivables_div_total_assets} | ${target2_y2_pre_payment_add_othr_receivables_div_total_assets}                      | ${target2_y3_pre_payment_add_othr_receivables_div_total_assets}                      | ${target2_y4_pre_payment_add_othr_receivables_div_total_assets}                      | ${target2_y5_pre_payment_add_othr_receivables_div_total_assets}                      |


| ${target3_company_name} | ${target3_y1}                              | ${target3_y2}                              | ${target3_y3}                              | ${target3_y4}                              | ${target3_y5}                              |
| ----------------------- |--------------------------------------------|--------------------------------------------|--------------------------------------------|--------------------------------------------|--------------------------------------------|
| 货币资金                | ${target3_y1_currency_funds}               | ${target3_y2_currency_funds}               | ${target3_y3_currency_funds}               | ${target3_y4_currency_funds}               | ${target3_y5_currency_funds}               |
| 利息收入                | ${target3_y1_finance_cost_interest_income} | ${target3_y2_finance_cost_interest_income} | ${target3_y3_finance_cost_interest_income} | ${target3_y4_finance_cost_interest_income} | ${target3_y5_finance_cost_interest_income} |
| 利息收入占比货币资金    | ${target3_y1_fcii_div_currency_funds}      | ${target3_y2_fcii_div_currency_funds}      | ${target3_y3_fcii_div_currency_funds}      | ${target3_y4_fcii_div_currency_funds}      | ${target3_y5_fcii_div_currency_funds}      |
| 利息支出                | ${target3_y1_finance_cost_interest_fee}    | ${target3_y2_finance_cost_interest_fee}    | ${target3_y3_finance_cost_interest_fee}    | ${target3_y4_finance_cost_interest_fee}    | ${target3_y5_finance_cost_interest_fee}    |
| 利息收入-利息支出              | ${target3_y1_fcii_m_fcif}                  | ${target3_y2_fcii_m_fcif}                  | ${target3_y3_fcii_m_fcif}                  | ${target3_y4_fcii_m_fcif}                  | ${target3_y5_fcii_m_fcif}                  |
| 净利润                     | ${target3_y1_net_profit}                   | ${target3_y2_net_profit}                   | ${target3_y3_net_profit}                   | ${target3_y4_net_profit}                   | ${target3_y5_net_profit}                   |
| 利息支出占比净利润              | ${target3_y1_fcif_div_net_profit}          | ${target3_y2_fcif_div_net_profit}                   | ${target3_y3_fcif_div_net_profit}                   | ${target3_y4_fcif_div_net_profit}                   | ${target3_y5_fcif_div_net_profit}                   |
| 预付款项                   | ${target3_y1_pre_payment}                                       | ${target3_y2_pre_payment}                             | ${target3_y3_pre_payment}                             | ${target3_y4_pre_payment}                             | ${target3_y5_pre_payment}                             |
| 其他应收款                  | ${target3_y1_othr_receivables}                                  | ${target3_y2_othr_receivables}                             | ${target3_y3_othr_receivables}                             | ${target3_y4_othr_receivables}                             | ${target3_y5_othr_receivables}                             |
| 总资产                    | ${target3_y1_total_assets}                                      | ${target3_y2_total_assets}                      | ${target3_y3_total_assets}                      | ${target3_y4_total_assets}                      | ${target3_y5_total_assets}                      |
| (预付款项+其他应收款)占比总资产             | ${target3_y1_pre_payment_add_othr_receivables_div_total_assets} | ${target3_y2_pre_payment_add_othr_receivables_div_total_assets}                      | ${target3_y3_pre_payment_add_othr_receivables_div_total_assets}                      | ${target3_y4_pre_payment_add_othr_receivables_div_total_assets}                      | ${target3_y5_pre_payment_add_othr_receivables_div_total_assets}                      |


通过对比三家公司，哪家最有财务造假的风险？


# 优质资产
优质资产主要包括：货币资金、交易性金融资产、银行承兑票据、存货、无形资产。
...
■ 应收票据需要看财务报表附注，在年报中搜索“应收票据”很容易可以找到。

■ 如果应收票据都是银行承兑票据，可以看作准货币资金。

■ 如果应收票据全部是商业承兑票据，可以看作应收账款。

■ 如果两种都有，银行承兑汇票部分看作准货币资金，商业承兑汇票部分看作应收账款。
...
| 交易性金融资产                | ${y1_tradable_fnncl_assets}                 | ${y2_tradable_fnncl_assets}                                          | ${y3_tradable_fnncl_assets}                                          | ${y4_tradable_fnncl_assets}                                          | ${y5_tradable_fnncl_assets}                                          |
| 存货                     | ${y1_inventory}                             | ${y2_inventory}            | ${y3_inventory}            | ${y4_inventory}            | ${y5_inventory}            |
| 无形资产                   | ${y1_intangible_assets}                     | ${y2_intangible_assets}                 | ${y3_intangible_assets}                 | ${y4_intangible_assets}                 | ${y5_intangible_assets}                 |
| 总资产                    | ${y1_total_assets}                          | ${y2_total_assets}                      | ${y3_total_assets}                      | ${y4_total_assets}                      | ${y5_total_assets}                      |
| 无形资产占比总资产              | ${y1_intangible_assets_div_total_assets}    | ${y2_intangible_assets_div_total_assets}                 | ${y3_intangible_assets_div_total_assets}                 | ${y4_intangible_assets_div_total_assets}                 | ${y5_intangible_assets_div_total_assets}                 |
| 存货占总资产比率               | ${y1_inventory_div_assets}                  | ${y2_inventory_div_assets} | ${y3_inventory_div_assets} | ${y4_inventory_div_assets} | ${y5_inventory_div_assets} |
| 准货币资金合计                | ${y1_total_currency_funds}                  | ${y2_total_currency_funds}                                           | ${y3_total_currency_funds}                                           | ${y4_total_currency_funds}                                           | ${y5_total_currency_funds}                                           |
| 准货币资金合计占比总资产           | ${y1_total_currency_funds_div_total_assets} | ${y2_total_currency_funds_div_total_assets}                                           | ${y3_total_currency_funds_div_total_assets}                                           | ${y4_total_currency_funds_div_total_assets}                                           | ${y5_total_currency_funds_div_total_assets}                                           |
| 优质资产占比总资产              | ${y1_high_quality_div_total_assets}         | ${y2_high_quality_div_total_assets}                                           | ${y3_high_quality_div_total_assets}                                           | ${y4_high_quality_div_total_assets}                                           | ${y5_high_quality_div_total_assets}                                           |
...
| 交易性金融资产                 | ${target2_y1_tradable_fnncl_assets} | ${target2_y2_tradable_fnncl_assets}                                          | ${target2_y3_tradable_fnncl_assets}                                          | ${target2_y4_tradable_fnncl_assets}                                          | ${target2_y5_tradable_fnncl_assets}                                          |
| 存货                    | ${target2_y1_inventory}            | ${target2_y2_inventory}            | ${target2_y3_inventory}            | ${target2_y4_inventory}            | ${target2_y5_inventory}            |
| 无形资产                   | ${target2_y1_intangible_assets}                 | ${target2_y2_intangible_assets}                 | ${target2_y3_intangible_assets}                 | ${target2_y4_intangible_assets}                 | ${target2_y5_intangible_assets}                 |
| 总资产                     | ${target2_y1_total_assets}                      | ${target2_y2_total_assets}                      | ${target2_y3_total_assets}                      | ${target2_y4_total_assets}                      | ${target2_y5_total_assets}                      |
| 无形资产占比总资产                   | ${target2_y1_intangible_assets_div_total_assets}            | ${target2_y2_intangible_assets_div_total_assets}                 | ${target2_y3_intangible_assets_div_total_assets}                 | ${target2_y4_intangible_assets_div_total_assets}                 | ${target2_y5_intangible_assets_div_total_assets}                 |
| 存货占总资产比率        | ${target2_y1_inventory_div_assets} | ${target2_y2_inventory_div_assets} | ${target2_y3_inventory_div_assets} | ${target2_y4_inventory_div_assets} | ${target2_y5_inventory_div_assets} |
| 准货币资金合计                 | ${target2_y1_total_currency_funds} | ${target2_y2_total_currency_funds}                                           | ${target2_y3_total_currency_funds}                                           | ${target2_y4_total_currency_funds}                                           | ${target2_y5_total_currency_funds}                                           |
| 准货币资金合计占比总资产           | ${target2_y1_total_currency_funds_div_total_assets}                                | ${target2_y2_total_currency_funds_div_total_assets}                                           | ${target2_y3_total_currency_funds_div_total_assets}                                           | ${target2_y4_total_currency_funds_div_total_assets}                                           | ${target2_y5_total_currency_funds_div_total_assets}                                           |
| 优质资产占比总资产              | ${target2_y1_high_quality_div_total_assets}         | ${target2_y2_high_quality_div_total_assets}                                           | ${target2_y3_high_quality_div_total_assets}                                           | ${target2_y4_high_quality_div_total_assets}                                           | ${target2_y5_high_quality_div_total_assets}                                           |
...
| 交易性金融资产                 | ${target3_y1_tradable_fnncl_assets}                                          | ${target3_y2_tradable_fnncl_assets}                                          | ${target3_y3_tradable_fnncl_assets}                                          | ${target3_y4_tradable_fnncl_assets}                                          | ${target3_y5_tradable_fnncl_assets}                                          |
| 存货                    | ${target3_y1_inventory}            | ${target3_y2_inventory}            | ${target3_y3_inventory}            | ${target3_y4_inventory}            | ${target3_y5_inventory}            |
| 无形资产                   | ${target3_y1_intangible_assets}                 | ${target3_y2_intangible_assets}                 | ${target3_y3_intangible_assets}                 | ${target3_y4_intangible_assets}                 | ${target3_y5_intangible_assets}                 |
| 总资产                     | ${target3_y1_total_assets}                      | ${target3_y2_total_assets}                      | ${target3_y3_total_assets}                      | ${target3_y4_total_assets}                      | ${target3_y5_total_assets}                      |
| 无形资产占比总资产                   | ${target3_y1_intangible_assets_div_total_assets}            | ${target3_y2_intangible_assets_div_total_assets}                 | ${target3_y3_intangible_assets_div_total_assets}                 | ${target3_y4_intangible_assets_div_total_assets}                 | ${target3_y5_intangible_assets_div_total_assets}                 |
| 存货占总资产比率        | ${target3_y1_inventory_div_assets} | ${target3_y2_inventory_div_assets} | ${target3_y3_inventory_div_assets} | ${target3_y4_inventory_div_assets} | ${target3_y5_inventory_div_assets} |
| 准货币资金合计                 | ${target3_y1_total_currency_funds}                                           | ${target3_y2_total_currency_funds}                                           | ${target3_y3_total_currency_funds}                                           | ${target3_y4_total_currency_funds}                                           | ${target3_y5_total_currency_funds}                                           |
| 准货币资金合计占比总资产           | ${target3_y1_total_currency_funds_div_total_assets}                                | ${target3_y2_total_currency_funds_div_total_assets}                                           | ${target3_y3_total_currency_funds_div_total_assets}                                           | ${target3_y4_total_currency_funds_div_total_assets}                                           | ${target3_y5_total_currency_funds_div_total_assets}                                           |
| 优质资产占比总资产              | ${target3_y1_high_quality_div_total_assets}         | ${target3_y2_high_quality_div_total_assets}                                           | ${target3_y3_high_quality_div_total_assets}                                           | ${target3_y4_high_quality_div_total_assets}                                           | ${target3_y5_high_quality_div_total_assets}                                           |


# 计算好价格买入

计算好价格有两种方法，1.动态市盈率好价格；2.股息率好价格

动态市盈率好价格计算公式：当前股票面值/动态市盈率*15

股息率好价格计算公式：股息/当前中国十年国债收益率*100

**股息率的计算分两种情况**

- 免个人所得税的，称为实际股息率(持有一年以上获得的股息率)
- 缴纳个人所得税的，称为买入股息率

股息个人所得税：持股1月内，20%；持股不到一年，10%，超过一年：免征个人所得税

买入股息率1（持有1月以内获得的股息分红）=（股息-股息*20%)/当前股票面值*

买入股息率2（持有2个月以上获得的股息分红）=（股息-股息*10%)/当前股票面值

可以去英为才情APP或者官网查中国十年国债收益率，也可以其他网上查到

当前中国十年国债收益率为：${target_10y_treasury_bond_yield} ，

好价格同行对比

| 指标                 | ${target_company_name}         | ${target2_company_name}         | ${target3_company_name}         |
| -------------------- | ------------------------------ | ------------------------------- | ------------------------------- |
| 流通市值             | ${target_float_market_capital} | ${target2_float_market_capital} | ${target3_float_market_capital} |
| 动态市盈率           | ${target_pe_ttm}               | ${target2_pe_ttm}               | ${target3_pe_ttm}               |
| 股息                 | ${target_dividend}             | ${target2_dividend}             | ${target3_dividend}             |
| 实际股息率           | ${target_dividend_yield}       | ${target2_dividend_yield}       | ${target3_dividend_yield}       |
| 买入股息率           | ${target_buy_dividend_yield}   | ${target2_buy_dividend_yield}   | ${target3_buy_dividend_yield}   |
| 股息率买入好价格     | ${target_dividend_price}       | ${target2_dividend_price}       | ${target3_dividend_price}       |
| 动态市盈率买入好价格 | ${target_pe_ttm_price}         | ${target2_pe_ttm_price}         | ${target3_pe_ttm_price}         |
| 当前股票面值         | ${target_current}              | ${target2_current}              | ${target3_current}              |

通过上表可以确定当前股票价格是否适合买入

如果当前股票面值小于股息率好价格和动态市盈率好价格中的最小值，并且股息率大于中国十年国债收益率，并且深证指数市盈率小于20，则可以大胆买入股票，长期持有
