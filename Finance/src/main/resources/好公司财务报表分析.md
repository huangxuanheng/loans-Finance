...
${target_company_name} 流通市值：${target_float_market_capital} ，动态市盈率(TTM):${target_pe_ttm}，股息为：${target_dividend}
...
当前买入股息率=${target_buy_dividend_yield}

实际股息率=${target_dividend_yield}
...
**当前股息率好价格为：${target_dividend_price}**

**当前动态市盈率好价格为：${target_pe_ttm_price}**

**当前的股票面值为：${target_current} **

如果当前股票面值小于股息率好价格和动态市盈率好价格中的最小值，并且股息率大于中国十年国债收益率，则可以大胆买入股票，长期持有
